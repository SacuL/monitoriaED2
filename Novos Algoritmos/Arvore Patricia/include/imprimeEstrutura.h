...
class imprimeEstrutura
{
    public:
        ...
        void setPriArvorePatricia(No_PAT** p);
    ...
    private:
        ...
        static void desenhaNoPAT(float *posPAT, string valor, int tamAlfa, int posOrd);
        ...
        static void percorrePatricia(No_PAT* p, float x, float y, float desX);
        ...
        static int alturaArvorePatricia(No_PAT *p);
