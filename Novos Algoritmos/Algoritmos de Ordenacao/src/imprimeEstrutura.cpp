...
void imprimeEstrutura::display(){
   ...
   glLoadIdentity();
   if(tipoEstrutura == 1 || tipoEstrutura == 2 || tipoEstrutura == 5 || tipoEstrutura == 4 || tipoEstrutura == 6 || tipoEstrutura == 7 || tipoEstrutura == 8 || tipoEstrutura == 9 || tipoEstrutura == 10 || tipoEstrutura == 11){
